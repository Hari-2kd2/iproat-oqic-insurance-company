    ...
    public function up()
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS SP_monthlyAttendance; CREATE PROCEDURE SP_monthlyAttendance(IN employeeId INT(10),IN from_date DATE,IN to_date DATE)
            BEGIN
                ...
                view_employee_in_out_data.finger_print_id,view_employee_in_out_data.date,view_employee_in_out_data.working_time, view_employee_in_out_data.employee_attendance_id,
