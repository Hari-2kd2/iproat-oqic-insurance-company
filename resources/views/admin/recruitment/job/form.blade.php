									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('job_title',old('job_title'), $attributes = array('class'=>'form-control required job_title','id'=>'job_title','placeholder'=>__('recruitement.job_title'))) !!}
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('post',old('post'), $attributes = array('class'=>'form-control required post','id'=>'post','placeholder'=>__('recruitement.job_post'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::textarea('job_description',old('job_description'), $attributes = array('class'=>'form-control textarea_editor required','rows'=>'15','id'=>'job_description','placeholder'=>__('recruitement.description'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{{ Form::select('status', array('1' => __('recruitement.published'), '0' => __('recruitement.unpublished')), old('status'), array('class' => 'form-control status  required')) }}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('publish_date',(isset($editModeData)) ? dateConvertDBtoForm($editModeData->publish_date) : old('publish_date'), $attributes = array('class'=>'form-control required dateField','id'=>'publish_date','placeholder'=>__('recruitement.job_publish_date'),'readonly'=>'readonly')) !!}
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<div class="input-group">
														...
														{!! Form::text('application_end_date',(isset($editModeData)) ? dateConvertDBtoForm($editModeData->application_end_date) : old('application_end_date'), $attributes = array('class'=>'form-control dateField','id'=>'application_end_date','readonly'=>'readonly','placeholder'=>__('recruitement.application_end_date'))) !!}
													</div>
												</div>
											</div>
										</div>
