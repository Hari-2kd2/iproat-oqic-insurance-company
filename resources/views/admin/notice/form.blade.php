									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('title',old('title'), $attributes = array('class'=>'form-control required title','id'=>'title','placeholder'=>__('notice.title'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::textarea('description',old('description'), $attributes = array('class'=>'form-control textarea_editor required','rows'=>'15','id'=>'description','placeholder'=>__('notice.description'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{{ Form::select('status', array('Published' => __('recruitement.published'), 'Unpublished' => __('recruitement.unpublished')), old('status'), array('class' => 'form-control status select2 required')) }}
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<div class="input-group">
														...
														{!! Form::text('publish_date',(isset($editModeData)) ? dateConvertDBtoForm($editModeData->publish_date) : old('publish_date'), $attributes = array('class'=>'form-control dateField','id'=>'publish_date','readonly'=>'readonly','placeholder'=>__('notice.publish_date'))) !!}
													</div>
												</div>
											</div>
										</div>
