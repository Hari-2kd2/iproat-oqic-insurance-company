...
@section('content')
@section('title')
    @lang('shift_change.requested_shift_change_request')
@endsection
                            ...
                            <table id="myDataTable" class="table table-bordered table-hover ">
                                <thead class="tr_header">
                                    <tr>
                                        ...
                                        <th>@lang('shift_change.request_date')</th>
                                        <th>@lang('shift_change.shift_name')</th>
                                        <th style="width: 300px;word-wrap: break-word;">@lang('common.purpose')</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($results as $value)
                                        <tr>
                                            ...
                                            <td>{!! shiftList($value->work_shift_id) !!}</td>
                                            <td>{!! $value->purpose !!}</td>
                                            @if ($value->status == 1)
                                            ...
                                            <td>
                                                @if ($value->status == 1)
                                                    <a href="{!! route('requestedShiftChangeRequest.viewDetails', $value->shift_change_request_id) !!}" title="View on duty details!"
