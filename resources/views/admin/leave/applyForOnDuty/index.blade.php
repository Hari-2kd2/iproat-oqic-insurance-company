...
@section('content')
@section('title')
    @lang('onduty.my_onduty_application_list')
@endsection
                            ...
                            <table class="table table-hover manage-u-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('onduty.request_duration')</th>
                                        <th>@lang('onduty.number_of_day')</th>
                                        <th>@lang('onduty.approve_status')</th>
                                        <th>@lang('onduty.reject_status')</th>
