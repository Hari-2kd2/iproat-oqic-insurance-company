									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('training_type_name',old('training_type_name'), $attributes = array('class'=>'form-control required training_type_name','id'=>'training_type_name','placeholder'=>__('training.training_type_name'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{{ Form::select('status', array('1' => __('common.active'), '2' => __('common.inactive')), old('status'), array('class' => 'form-control status select2 required')) }}
												</div>
											</div>
										</div>
									</div>
