								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											{{ Form::select('training_type_id', $trainingTypeList, old('training_type_id'), array('class' => 'form-control training_type_id required select2')) }}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											{!! Form::text('subject',old('subject'), $attributes = array('class'=>'form-control required subject','id'=>'subject','placeholder'=>__('training.training_type'))) !!}
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="input-group">
											...
											{!! Form::text('start_date',isset($editModeData) ? dateConvertDBtoForm($editModeData->start_date) : old('start_date'), $attributes = array('class'=>'form-control required dateField','readonly'=>'readonly','id'=>'start_date','placeholder'=>__('common.from_date'))) !!}
										</div>
									</div>
									<div class="col-md-4">
										...
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											{!! Form::text('end_date',isset($editModeData) ? dateConvertDBtoForm($editModeData->end_date) : old('end_date'), $attributes = array('class'=>'form-control required dateField','readonly'=>'readonly','id'=>'end_date','placeholder'=>__('common.to_date'))) !!}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											{!! Form::textarea('description',old('description'), $attributes = array('class'=>'form-control','id'=>'description','placeholder'=>__('training.description'),'cols'=>'30','rows'=>'4')) !!}
										</div>
									</div>
								</div>
