									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('allowance_name',old('allowance_name'), $attributes = array('class'=>'form-control required allowance_name','id'=>'allowance_name','placeholder'=>__('allowance.allowance_name'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{{ Form::select('allowance_type', array('Percentage' => 'Percentage', 'Fixed' => 'Fixed'), old('allowance_type'), array('class' => 'form-control allowance_type required')) }}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::number('percentage_of_basic',old('percentage_of_basic'), $attributes = array('class'=>'form-control required percentage_of_basic','id'=>'percentage_of_basic','placeholder'=>__('allowance.percentage_of_basic'),'min'=>'0','max'=>'100')) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::number('limit_per_month',old('limit_per_month'), $attributes = array('class'=>'form-control required limit_per_month','id'=>'limit_per_month','placeholder'=>__('allowance.limit_per_month'),'min'=>'0')) !!}
												</div>
											</div>
										</div>
									</div>
