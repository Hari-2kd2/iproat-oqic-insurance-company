									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('deduction_name',old('deduction_name'), $attributes = array('class'=>'form-control required deduction_name','id'=>'deduction_name','placeholder'=>__('deduction.deduction_name'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{{ Form::select('deduction_type', array('Percentage' => 'Percentage', 'Fixed' => 'Fixed'), old('deduction_type'), array('class' => 'form-control deduction_type required')) }}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::number('percentage_of_basic',old('percentage_of_basic'), $attributes = array('class'=>'form-control required percentage_of_basic','id'=>'percentage_of_basic','placeholder'=>__('deduction.percentage_of_basic'),'min'=>'0','max'=>'100')) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::number('limit_per_month',old('limit_per_month'), $attributes = array('class'=>'form-control required limit_per_month','id'=>'limit','placeholder'=>__('deduction.limit_per_month'),'min'=>'0')) !!}
												</div>
											</div>
										</div>
									</div>
