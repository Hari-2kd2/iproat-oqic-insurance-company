							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										...
										{!! Form::text('pay_grade_name',old('pay_grade_name'), $attributes = array('class'=>'form-control required pay_grade_name','id'=>'pay_grade_name','placeholder'=>__('paygrade.pay_grade_name'))) !!}
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput">@lang('paygrade.gross_salary')<span class="validateRq">*</span></label>
										{!! Form::number('gross_salary',old('gross_salary'), $attributes = array('class'=>'form-control required gross_salary','id'=>'gross_salary','placeholder'=>__('paygrade.gross_salary'),'min'=>'0')) !!}
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										{!! Form::number('basic_salary',old('basic_salary'), $attributes = array('class'=>'form-control required basic_salary','readonly'=>'readonly','id'=>'basic_salary','placeholder'=>__('paygrade.basic_salary'),'min'=>'0')) !!}
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										{!! Form::number('overtime_rate',old('overtime_rate'), $attributes = array('class'=>'form-control overtime_rate','id'=>'overtime_rate','placeholder'=>__('paygrade.over_time_rate'),'min'=>'0')) !!}
									</div>
								</div>
