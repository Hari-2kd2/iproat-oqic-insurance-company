									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('hourly_grade',old('hourly_grade'), $attributes = array('class'=>'form-control required hourly_grade','id'=>'hourly_grade','placeholder'=>__('paygrade.pay_grade_name'))) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::number('hourly_rate',old('hourly_rate'), $attributes = array('class'=>'form-control required hourly_rate','id'=>'hourly_rate','placeholder'=>__('paygrade.hourly_rate'),'min'=>'0')) !!}
												</div>
											</div>
										</div>
									</div>
