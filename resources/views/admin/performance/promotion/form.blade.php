								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											{{ Form::select('employee_id', $employeeList, old('employee_id'), array('class' => 'form-control employee_id required select2')) }}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">@lang('promotion.current_department')<span class="validateRq">*</span></label>
											{{ Form::select('current_department', $departmentList, old('current_department'), array('class' => 'form-control current_department required','id'=>'current_department','style'=>'pointer-events: none')) }}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">@lang('promotion.current_designation')<span class="validateRq">*</span></label>
											{{ Form::select('current_designation', $designationList, old('current_designation'), array('class' => 'form-control current_designation required','id'=>'current_designation','style'=>'pointer-events: none')) }}
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											{{ Form::select('current_pay_grade', $payGradeList, old('current_pay_grade'), array('class' => 'form-control current_pay_grade required ','id'=>'current_pay_grade','style'=>'pointer-events: none')) }}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">@lang('promotion.current_salary')<span class="validateRq">*</span></label>
											{!! Form::text('current_salary',old('current_salary'), $attributes = array('class'=>'form-control required current_salary','id'=>'current_salary','readonly'=>'readonly','placeholder'=>__('promotion.current_salary'))) !!}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">@lang('promotion.promoted_pay_grade')<span class="validateRq">*</span></label>
											{{ Form::select('promoted_pay_grade', $payGradeList, old('promoted_pay_grade'), array('class' => 'form-control promoted_pay_grade required select2','id'=>'promoted_pay_grade')) }}
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											{!! Form::text('new_salary',old('new_salary'), $attributes = array('class'=>'form-control required new_salary','id'=>'new_salary','readonly'=>'readonly','placeholder'=>__('promotion.new_salary'))) !!}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">@lang('promotion.promoted_department')<span class="validateRq">*</span></label>
											{{ Form::select('promoted_department', $departmentList, old('promoted_department'), array('class' => 'form-control promoted_department required select2')) }}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">@lang('promotion.promoted_designation')<span class="validateRq">*</span></label>
											{{ Form::select('promoted_designation', $designationList, old('promoted_designation'), array('class' => 'form-control promoted_designation required select2')) }}
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="input-group">
											...
											{!! Form::text('promotion_date',isset($editModeData) ? dateConvertDBtoForm($editModeData->promotion_date) : old('promotion_date'), $attributes = array('class'=>'form-control required dateField','readonly'=>'readonly','placeholder'=>__('promotion.promotion_date'))) !!}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">@lang('warning.description')</label>
											{!! Form::textarea('description',old('description'), $attributes = array('class'=>'form-control description','id'=>'description','cols'=>'50','rows'=>'3','placeholder'=>__('warning.description'))) !!}
										</div>
									</div>
								</div>
