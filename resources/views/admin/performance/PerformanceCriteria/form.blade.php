								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{{ Form::select('performance_category_id',$performanceCategory, old('performance_category_id'), array('class' => 'form-control performance_category_id select2 required')) }}
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{!! Form::text('performance_criteria_name',old('performance_criteria_name'), $attributes = array('class'=>'form-control required performance_criteria_name','id'=>'performance_criteria_name','placeholder'=>__('performance.criteria_name'))) !!}
											</div>
										</div>
									</div>
								</div>
