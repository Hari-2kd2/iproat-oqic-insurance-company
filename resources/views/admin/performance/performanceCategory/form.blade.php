								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{!! Form::text('performance_category_name',old('performance_category_name'), $attributes = array('class'=>'form-control required performance_category_name','id'=>'performance_category_name','placeholder'=>__('performance.performance_category_name'))) !!}
											</div>
										</div>
									</div>
								</div>
