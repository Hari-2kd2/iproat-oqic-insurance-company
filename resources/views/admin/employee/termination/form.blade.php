							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-8">
											{{ Form::select('terminate_to',$employeeList, old('terminate_to'), array('class' => 'form-control terminate_to select2 required')) }}
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-8">
											{!! Form::text('termination_type',old('termination_type'), $attributes = array('class'=>'form-control required termination_type','id'=>'terminate_type','placeholder'=>__('termination.termination_type'))) !!}
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-8">
											{!! Form::text('subject',old('subject'), $attributes = array('class'=>'form-control required subject','id'=>'subject','placeholder'=>__('termination.subject'))) !!}
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-8">
											{{ Form::select('terminate_by',$employeeList, isset($editModeData) ? old('terminate_by') : decrypt(session('logged_session_data.employee_id')), array('class' => 'form-control terminate_by select2 required')) }}
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">
												...
												{!! Form::text('notice_date',isset($editModeData) ? dateConvertDBtoForm($editModeData->notice_date) : old('notice_date'), $attributes = array('class'=>'form-control required dateField','id'=>'notice_date','placeholder'=>__('termination.notice_date'),'readonly'=>'readonly')) !!}
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">
												<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
												{!! Form::text('termination_date',isset($editModeData) ? dateConvertDBtoForm($editModeData->termination_date) : old('termination_date'), $attributes = array('class'=>'form-control required dateField','id'=>'termination_date','placeholder'=>__('termination.termination_date'),'readonly'=>'readonly')) !!}
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-md-8">
											{!! Form::textarea('description',old('description'), $attributes = array('class'=>'form-control description','id'=>'warning_date','placeholder'=>__('termination.description'))) !!}
										</div>
									</div>
								</div>
							</div>
