								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{{ Form::select('warning_to',$employeeList, old('warning_to'), array('class' => 'form-control warning_to select2 required')) }}
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{!! Form::text('warning_type',old('warning_type'), $attributes = array('class'=>'form-control required warning_type','id'=>'warning_type','placeholder'=>__('warning.warning_type'))) !!}
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{!! Form::text('subject',old('subject'), $attributes = array('class'=>'form-control required subject','id'=>'subject','placeholder'=>__('warning.subject'))) !!}
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												...
												{!! Form::text('warning_date',isset($editModeData) ? dateConvertDBtoForm($editModeData->warning_date) : old('warning_date'), $attributes = array('class'=>'form-control required dateField','id'=>'warning_date','placeholder'=>__('warning.warning_date'),'readonly'=>'readonly')) !!}
												</div>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{!! Form::textarea('description',old('description'), $attributes = array('class'=>'form-control description','id'=>'warning_date','placeholder'=>__('warning.description'))) !!}
											</div>
										</div>
									</div>
								</div>
