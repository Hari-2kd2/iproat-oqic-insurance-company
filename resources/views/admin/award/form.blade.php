									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{{ Form::select('award_name', employeeAward(), old('award_name'), array('class' => 'form-control award_name required select2')) }}
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('gift_item',old('gift_item'), $attributes = array('class'=>'form-control required gift_item','id'=>'gift_item','placeholder'=>__('award.gift_item'))) !!}
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<div class="input-group">
														...
														{!! Form::text('month',old('month'), $attributes = array('class'=>'form-control required monthField','readonly'=>'readonly','id'=>'month','placeholder'=>__('common.month'))) !!}
													</div>
												</div>
											</div>
										</div>
